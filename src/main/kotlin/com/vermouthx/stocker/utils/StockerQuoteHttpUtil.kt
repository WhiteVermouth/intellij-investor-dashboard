            ...
            .map { textArray ->
                when (marketType) {
                    StockerMarketType.AShare -> {
                        ...
                        val percentage = ((current - close) / close * 100).roundToString() + "%"
                        val updateAt = textArray[31] + " " + textArray[32]
                        StockerStockQuote(
                            code = code,
                            name = name,
                            current = current.roundToString(),
                            opening = opening.roundToString(),
                            close = close.roundToString(),
                            low = low.roundToString(),
                            high = high.roundToString(),
                    ...
                    StockerMarketType.HKStocks -> {
                        ...
                        val percentage = textArray[9].toDouble().roundToString() + "%"
